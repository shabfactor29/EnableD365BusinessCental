...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public static class AppReference
    {
        ...
        public static class BusinessCentral
        {
            ...
            public static string InactiveSearchInRecordsButton = "BC_InactiveSearchInRecordsButton";
            public static string ActiveSearchInRecordsButton = "BC_ActiveSearchInRecordsButton";
            ...
            public static string DocumentsMenuOptionButton = "BC_DocumentsMenuOptionButton";
    ...
    public static class AppElements
    {
        ...
        //---------------------------- D365 Business Central -----------------------------------------
            ...
            //Navigation
            { "BC_SearchForPage_Button"             , "//*[@id='search']"},
            { "BC_AccountManagerButton"             , "//span[text()='E']/ancestor::a" },
            { "BC_AccountManagerSignOutButton"      , "//span[text()='Sign out']" },
            { "BC_Dialog_Button"                    , "//form[@controlname='Dialog' or @role='dialog']//button/span[text()='[BUTTONNAME]']"},
            ...
            { "BC_Search_Results"       , "//form[not(@tabindex)]//div[@class='ms-nav-scrollable']" },
            ...
            { "BC_Grid_RecordLink"       , "//form[not(@tabindex)]//a[@title='Open record \"[RECORDNO]\"' or @title='Show more about \"[RECORDNO]\"']" },
            { "BC_InactiveSearchInRecordsButton", "//form[not(@tabindex)]//div[text()='Search']/parent::div"},
            { "BC_ActiveSearchInRecordsButton", "//form[not(@tabindex)]//input[@placeholder='Search']"},
            ...
            { "BC_TopMenu", "//form[not(@tabindex)]//span[text()='[TITLE]']/ancestor::a[@aria-label='[TITLE]']"},
            { "BC_TopSubmenu", "//form[not(@tabindex)]//span[text()='[TITLE]']/ancestor::a"},
            { "BC_SendConfirmationButton", "//form[not(@tabindex)]//span[text()='OK']"},
            { "BC_SendEmailButton", "//form[not(@tabindex)]//span[text()='Send Email']"},
            { "BC_EmailField", "//form[not(@tabindex)]//a[text()='To']/following-sibling::div/input"},
            { "BC_SectionHeaderFolded"        ,"//form[not(@tabindex)]//span[@class='caption-text'][text()='[SECTIONNAME]']/parent::span[@aria-expanded='false']" },
            { "BC_SectionHeaderFolded2"        ,"//form[not(@tabindex)]//span[@title='[SECTIONNAME]' and @aria-expanded='false']" },
            { "BC_TextFieldContainer"       , "//form[not(@tabindex)]//*[text()='[SECTIONNAME]']/../../..//div[@class='collapsibleTab' or contains(@class,'collapsible')]//a[text()='[FIELDNAME]']/parent::div[not(contains(@class,'ms-nav-hidden'))]/div/*[self::input or self::span]" },
            { "BC_TextFieldContainer2"       , "//form[not(@tabindex)]//*[text()='[SECTIONNAME]']/../../..//div[@class='collapsibleTab' or contains(@class,'collapsible')]//a[text()='[FIELDNAME]']/parent::div[not(contains(@class,'ms-nav-hidden'))]/div/a" },
            ...
            { "BC_New"       , "//form[not(@tabindex)]//a[@title='Create a new entry.'][@role='menuitem']"},
            ...
            { "BC_DocumentsMenuOptionButton", "//form[not(@tabindex)]//div[text()='[DOCUMENTSOPTION]']"},
            { "BC_LineMenuToggle", "//form[not(@tabindex)]//div[@class='ms-nav-band-header']//span[text()='[TOGGLEOPTION]']"},
            { "BC_LineTopMenu", "//form[not(@tabindex)]//span[text()='[TITLE]']/ancestor::a"},
            { "BC_LineTopSubmenu", "//form[not(@tabindex)]//span[text()='[TITLE]']/ancestor::a"},
            { "BC_GenericField", "//form[not(@tabindex)]//a[text()='[FIELDNAME]']/parent::div[not(contains(@class,'ms-nav-hidden'))]/div"},
            
            //Entity - Lines
            { "BC_LineRowContainer"                 , "//form[not(@tabindex)]//tbody/tr[@role='row'][[LINENUMBER]]/td[1]" },
            { "BC_LineRowContainers"                , "//form[not(@tabindex)]//tbody/tr[@role='row' and not(contains(@class,'draft-line'))]" },
            { "BC_LineRowContainersOfTable"         , "//form[not(@tabindex)]//div[@class='ms-nav-band-header']//*[self::div or self::a][contains(text(),'[TABLENAME]')]/ancestor::div[contains(@class,'formhost-control')]//tbody/tr[@role='row' and not(contains(@class,'draft-line'))]" },
            { "BC_LineHeaders"                      , "//form[not(@tabindex)]//thead[not(@aria-hidden='true')]//th[@role='columnheader']" },
            { "BC_LineTextFieldContainerEdit"       , "//form[not(@tabindex)]//tbody/tr[@role='row'][[LINENUMBER]]/td[@controlname='[FIELDNAME]']" },
            { "BC_LineTextFieldContainerRead"       , "//form[not(@tabindex)]//tbody/tr[@role='row'][[LINENUMBER]]/td[[COLUMNINDEX]]//*[self::span or self::a]" },
