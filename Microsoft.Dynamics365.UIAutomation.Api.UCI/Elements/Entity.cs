...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    ...
    where T : Element
        ...
        public string Bc_GetEntityNoFromHeader()
        {
        ...
        public void BC_SetField(string sectionName, string fieldName, string fieldValue)
        {
            _client.BC_SetField(sectionName, fieldName, fieldValue);
        }

        // Sets the value of a field, not located in a section
        public void BC_SetField(string fieldName, string fieldValue)
        {
        ...
        /// </summary>
        /// <param name="field">The field</param>
        public string BC_AutocompleteField(string sectionName, string fieldName)
        {
            return _client.BC_AutocompleteField(sectionName, fieldName);
        }

        public void BC_ClickLinkInField(string sectionName, string fieldName)
        {
            _client.BC_ClickLinkInField(sectionName, fieldName);
        }

        public void BC_SetLineField(int lineNumber, string lineFieldName, string lineFieldValue)
        {
            _client.BC_SetLineField(lineNumber, lineFieldName, lineFieldValue);
        }

        public void BC_ChooseLineOption(int lineNumber, string optionName)
        {
            _client.BC_ChooseLineOption(lineNumber, optionName);
        }

        public void BC_ChooseLineOption(int lineNumber, string optionName, string tableName)
        {
            _client.BC_ChooseLineOption(lineNumber, optionName, tableName);
        }

        public string BC_GetLineField(int lineNumber, string lineFieldName)
        {
            return _client.BC_GetLineField(lineNumber, lineFieldName);
        }

        public int BC_GetNumberOfLines()
        {
            return _client.BC_GetNumberOfLines();
        }
        public int BC_GetNumberOfLines(string tableName)
        {
            return _client.BC_GetNumberOfLines(tableName);
        }

        public bool BC_SendApprovalRequest()
        {
            _client.BC_ClickMenuAndSubmenu("Request Approval", "Send Approval Request");

            if (!_client.BC_Dialog_GetText().Value.Equals(""))
            {
                _client.BC_Check_DialogText("Do you want to update the lines?");
        ...
        public bool BC_EmailVendor(SecureString email)
        {
            _client.BC_ClickMenuAndSubmenu("Print/Send", "Send...");
            return _client.BC_EmailVendor(email);
        }

        public bool BC_CopyDocument(string documentType, string documentNo)
        {
            _client.BC_ClickMenuAndSubmenu("Prepare", "Copy Document...");
            return _client.BC_CopySalesDocument(documentType, documentNo);
        }

        public bool BC_Post_UsingPosting()
        {
            _client.BC_ClickMenuAndSubmenu("Posting", "Post");
            _client.ThinkTime(1000); //TODO: performance improvements
            _client.BC_Check_DialogText("Do you want to post the");
            _client.ThinkTime(1000); //TODO: performance improvements
            _client.BC_Dialog_ClickButton("Yes");
            _client.ThinkTime(1000); //TODO: performance improvements
            if (!_client.BC_Dialog_GetText().Value.Equals("Do you want to open the posted"))
            {
                _client.ThinkTime(1000); //TODO: performance improvements
                _client.BC_Dialog_ClickButton("Yes");
            }
        ...
        public bool BC_Post_UsingPostPrint()
        {
            _client.BC_ClickMenuAndSubmenu("Post/Print", "Post");
            _client.ThinkTime(1000); //TODO: performance improvements
            _client.BC_Check_DialogText("Do you want to post the");
            _client.ThinkTime(1000); //TODO: performance improvements
            _client.BC_Dialog_ClickButton("Yes");
        ...
        public bool BC_PostWithOption(string optionName)
        {
            _client.BC_ClickMenuAndSubmenu("Posting", "Post...");
            _client.ThinkTime(1000); //TODO: performance improvements        
        ...
        public bool BC_GenerateSuggestedLines()
        {
            _client.BC_ClickMenuAndSubmenu("Process", "Suggest Lines...");
            return _client.BC_SuggestBankAccReconLines();
        }

        public bool BC_OpenLedgerEntries()
        {
            return _client.BC_ClickMenuAndSubmenu("Customer", "Ledger Entries");
        }

        public string BC_GetDialogMessage()
        {
            return _client.BC_Dialog_GetText().Value;
        }

        public bool BC_Dialog_ClickButton(string buttonName)
        {
            return _client.BC_Dialog_ClickButton(buttonName);
        }

        public bool BC_CheckColumnEmpty(string columnName)
        {
            return _client.BC_CheckColumnEmpty(columnName);
        }

        public bool BC_CheckColumnsHaveSameValues(string givenColumn, string columnToCheck)
        {
            return _client.BC_CheckColumnsHaveSameValues(givenColumn, columnToCheck);
        }

        public bool BC_NavigateToDocumentsAndSelect(string documentsOption)
        {
            return _client.BC_ClickMenuAndSubmenu("Related", "Documents", documentsOption);
        }

        public bool BC_SelectOptionFunction(string function)
        {
